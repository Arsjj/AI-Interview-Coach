...
export function InterviewDetails({ answers, session }: Props) {
...
const Answer = ({ answers }: { answers: InterviewAnswer[] }) => {
    return (
                ...
                answers.map((item, index) => (
                    ...
                    >
                        ...
                        <div className="mt-4 sm:mt-5">
                            ...
                            <p className="mt-2 wrap-break-word text-sm leading-6 text-slate-700 dark:text-slate-300">
                                {item.answer}
                            </p>
                        </div>
                        ...
                        <div className="mt-4 sm:mt-5">
                            <h3 className="font-semibold">Good answer</h3>
